...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 16 déc. 2019 à 15:06
...
CREATE TABLE IF NOT EXISTS `prestations` (
  ...
  `idContrat` int(11) NOT NULL,
  PRIMARY KEY (`idPrest`),
  KEY `fkIdx_165` (`idUser`),
  KEY `fkIdx_168` (`idContrat`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `intervenant`
  ...
  ADD CONSTRAINT `FK_86` FOREIGN KEY (`idAdresse`) REFERENCES `adresse` (`idAdresse`);

--
-- Contraintes pour la table `interv_mail`
--
ALTER TABLE `interv_mail`
  ADD CONSTRAINT `FK_117` FOREIGN KEY (`idInt`) REFERENCES `intervenant` (`idInt`),
  ADD CONSTRAINT `FK_120` FOREIGN KEY (`idMail`) REFERENCES `mail` (`idMail`);
...
ALTER TABLE `prestations`
  ADD CONSTRAINT `FK_165` FOREIGN KEY (`idUser`) REFERENCES `user` (`idUser`),
  ADD CONSTRAINT `FK_168` FOREIGN KEY (`idContrat`) REFERENCES `contrat` (`idContrat`);
COMMIT;
